        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <input
              type="password"
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffd700]"
              placeholder="Create a password" id='password' onChange={handleChange} />
          </div>
          ...
          <div className="mb-6">
            <div className="flex">
              <input
                ...
                readOnly id='countryCode' />
              <input
                type="tel"
                className="w-3/4 px-4 py-2 border rounded-r-lg focus:outline-none focus:ring-2 focus:ring-[#ffd700]"
                placeholder="Enter your phone number" id='phonenumber' onChange={handleChange} />
            </div>
          </div>
